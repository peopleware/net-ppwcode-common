...
public class DateTimeOffsetExtensionsFactory
{
    ...
    {
        get { yield return new TestCaseData(null, 5).Returns(null); }
    }
    ...
    {
        get { yield return new TestCaseData((DateTimeOffset?)null).Returns(false); }
    }
    ...
    public static IEnumerable GetUtcDateTime
    {
        get
        {
            yield return new TestCaseData(D(2015, 01, 01)).Returns(D(2015, 01, 01));
            yield return new TestCaseData(D(2015, 02, 05)).Returns(D(2015, 02, 05));
            yield return new TestCaseData(D(2015, 03, 07)).Returns(D(2015, 03, 07));
            yield return new TestCaseData(D(2015, 04, 08)).Returns(D(2015, 04, 08));
            yield return new TestCaseData(D(2015, 05, 11)).Returns(D(2015, 05, 11));
            yield return new TestCaseData(D(2015, 06, 21)).Returns(D(2015, 06, 21));
            yield return new TestCaseData(D(2015, 07, 01)).Returns(D(2015, 07, 01));
            yield return new TestCaseData(D(2015, 08, 12)).Returns(D(2015, 08, 12));
            yield return new TestCaseData(D(2015, 09, 13)).Returns(D(2015, 09, 13));
            yield return new TestCaseData(D(2015, 10, 14)).Returns(D(2015, 10, 14));
            yield return new TestCaseData(D(2015, 11, 22)).Returns(D(2015, 11, 22));
            yield return new TestCaseData(D(2016, 12, 29)).Returns(D(2016, 12, 29));
            yield return new TestCaseData(D(2016, 12, 30)).Returns(D(2016, 12, 30));
            yield return new TestCaseData(D(2015, 02, 28)).Returns(D(2015, 02, 28));
            yield return new TestCaseData(D(2015, 01, 5)).Returns(D(2015, 01, 5));
            yield return new TestCaseData(D(2015, 02, 12)).Returns(D(2015, 02, 12));
            yield return new TestCaseData(D(2015, 03, 20)).Returns(D(2015, 03, 20));
            yield return new TestCaseData(D(2015, 04, 21)).Returns(D(2015, 04, 21));
            yield return new TestCaseData(D(2015, 05, 30)).Returns(D(2015, 05, 30));
            yield return new TestCaseData(D(2015, 06, 4)).Returns(D(2015, 06, 4));
        }
    }
    ...
    private static DateTimeOffset D(int year, int month, int day, int hour = 0, int minute = 0, int second = 0)
